...
public class gasto_activity extends AppCompatActivity {
    ...
    public void fillSpinner() {
        ...
        collRef.whereEqualTo("tipo", false).get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<String>(gasto_activity.this, android.R.layout.simple_spinner_item, spinnerItens);
    ...
    public void submitGasto(View view) {
